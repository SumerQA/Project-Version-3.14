...
public class Cost_Schemes_Page {
	...
	{   
	 ...
	 public void Update_Collection_Cost_Scheme_range(String ePath,String updatePath,String from) throws IOException, InterruptedException {
			...
			Thread.sleep(800);
			driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[2]/span[1]/span/input[2]")).clear();
			Thread.sleep(3000);
			driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[2]/span[1]/span/input[2]")).sendKeys(from);
			/*driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[3]/span[1]/span/input[1]")).clear();
			driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[3]/span[1]/span/input[1]")).sendKeys(to);
			driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[4]/span[1]/span/input[1]")).clear();
			driver.findElement(By.xpath(c.getElementName(ePath) + "/tr[" + cou+ "]/td[4]/span[1]/span/input[1]")).sendKeys(value);*/
		     }
