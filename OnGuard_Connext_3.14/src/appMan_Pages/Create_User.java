...
public class Create_User {
	...
	public void Check_SendEmailBYme(String id, String text, String SMTPUser,
			String SMTPpwd) throws IOException {
		events eve = new events(driver);
		...
		if (text.equals("Yes")) {
			...
			if (checkboxStatus) {
				...
				eve.SendKey_event("Settings_Mail_server_uname", SMTPUser);
				eve.SendKey_event("Settings_Mail_server_pwd", SMTPpwd);
			} else {
