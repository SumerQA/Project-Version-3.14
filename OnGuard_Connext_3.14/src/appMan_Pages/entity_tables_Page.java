...
public class entity_tables_Page {
	...
	{   
	 ...
	 public void Enter_Entity_Values(String path, String text) throws IOException, InterruptedException {
		 WebElement element = driver.findElement(By.xpath(c.getElementName(path)));
			...
			for (int rownum = 0; rownum < rows.size(); rownum++) {
						...
						driver.findElement(By.xpath(c.getElementName(path) + "/tr[" + rowno+ "]/td[2]/input")).clear();
