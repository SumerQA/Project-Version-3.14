...
public class Authorisations_Page {
	...
	@Test
	 public void Users_Table(String compTest,String ePath) throws IOException, InterruptedException {	                  
		events eve = new events(driver);
	...
	@Test
	 public void Users_Linked_to_Role_Table(String compTest,String ePath) throws IOException, InterruptedException {	                  
		events eve = new events(driver);
	  	eve.Table_event(compTest, ePath);
	  	Thread.sleep(1000);
	    }
