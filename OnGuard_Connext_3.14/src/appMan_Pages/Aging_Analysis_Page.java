...
public class Aging_Analysis_Page {
	...
	public void Add_range_Table(String path, String a, String b) throws IOException, InterruptedException {
		WebElement element = driver
				.findElement(By.xpath(c.getElementName(path)));
		...
		for (int rownum = 0; rownum < rows.size(); rownum++) {
			...
			for (int colnum = 0; colnum < columns.size(); colnum++) {
				...
				if (columns.get(colnum).getText().equals("0")) {
					...
					driver.findElement(By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["+ rowno + "]/td[1]/span[1]/span/input[2]")).sendKeys(a);
					driver.findElement(	By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["+ rowno + "]/td[1]/span[1]/span/input[2]")).sendKeys(Keys.ENTER);
					Thread.sleep(1000);
					driver.findElement(By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["	+ rowno + "]/td[2]")).click();
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["+ rowno + "]/td[2]/span[1]/span/input[2]")).clear();
					driver.findElement(By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["+ rowno + "]/td[2]/span[1]/span/input[2]")).sendKeys(b);
					driver.findElement(By.xpath("//*[@id='grid_bucket']/div[3]/table/tbody/tr["+ rowno + "]/td[2]/span[1]/span/input[2]")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					break;
				}
			}
