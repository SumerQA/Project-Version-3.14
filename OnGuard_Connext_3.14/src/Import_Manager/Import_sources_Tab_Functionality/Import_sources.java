...
public class Import_sources {
  ...
  @Test(priority=6)
  public void Enter_Required_Fields_in_SMTP_Settings_section() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Import_Sources_Page IS_page= PageFactory.initElements(driver, Import_Sources_Page.class);
	  IS_page.SMTP_Settings_Tab();
	  IS_page.Enter_Email_Address(arr.get(18));
	  IS_page.Enter_Mail_Server_Username(arr.get(19));
	  IS_page.Enter_Mail_Server_password(arr.get(20));
  }
  @Test(priority=7)
  ...
  public void Create_sources_to_link_with_ImportSource() throws IOException, InterruptedException {
	  ...
	  Thread.sleep(500);
	  IS_page.link_to_Import_Sources(arr.get(0));
	  Thread.sleep(500);
	  IS_page.Customer_XML_Path(arr.get(3));
	  Thread.sleep(300);
	  IS_page.Invoice_XML_Path(arr.get(4));
	  ...
	  Enter_Required_Fields_in_SMTP_Settings_section();
	  IS_page.clickon_Save_IM_Change_icon();
	  Thread.sleep(800);
	  IS_page.Save_changes_Notification();
	  Thread.sleep(800);
  ...
  @Test(priority=9,description="APP-582:Unique import source name")
  ...
  @Test(priority=10,description="APP-580: Update import source button")
