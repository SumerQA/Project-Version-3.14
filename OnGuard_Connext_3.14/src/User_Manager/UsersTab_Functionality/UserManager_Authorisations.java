...
public class UserManager_Authorisations {
  ...
  public void Check_Default_Role_for_Newly_Created_User_Under_Onguard_Connext_Viewer_Role() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Verify Default role for Newly Created User");	 
	  auth_obj.Users_Table(arr.get(0),"R_user_table");
	  auth_obj.Roles_Table("OnGuard Connext Viewer", "R_roles_table");
	  auth_obj.Users_Linked_to_Role_Table(arr.get(0), "R_roleslinked_Table");
	  Reporter.log("********Verify Default role for Newly Created User********");
	  Reporter.log("----------------------------------------");
	  }
 
@Test(priority = 3)
  public void Create_New_ChieldRole_for_OnGuard_Connext_Account_Manager() throws IOException, InterruptedException {
	 WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Create New Role for OnGuard Connext Account Manager");
	  ...
	  auth_obj.Copy_Of("R_copy_of", "OnGuard Connext Account Manager");	 	
	  auth_obj.Role_Save_and_Close_Icon();
	  auth_obj.Notification();
	  Thread.sleep(2000);
	  Reporter.log("********New Role Created for OnGuard Connext Account Manager ********");
	  Reporter.log("----------------------------------------");
	  }
 
  @Test(priority = 4)
  public void Create_New_ChieldRole_for_OnGuard_Connext_Credit_manager() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Create New Role for OnGuard Connext Credit Manager");
	  auth_obj.Create_New_AuthRole_panal();
	  Thread.sleep(1000);
	  auth_obj.Role_Name("R_name", arr.get(2));
	  auth_obj.Description("R_desc", "Created for Credit Manager");
	  auth_obj.Copy_Of("R_copy_of", "OnGuard Connext Credit Manager");
	  auth_obj.Role_Save_and_Close_Icon();
	  Thread.sleep(2000);
  ...
  @Test(priority = 5)
  public void Link_New_User_to_OnGuard_Connext_Account_Manager_ChieldRole() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Link New User to OnGuard Connext Account Manager Role");
	  auth_obj.Users_Table(arr.get(0),"R_user_table");
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1),"No");
	  auth_obj.Link_button();
	  auth_obj.Notification();
	  auth_obj.Notification();
	  auth_obj.Save_After_linking_Icon();
	  auth_obj.Expand_and_Collepse_Table("OnGuard Connext Account Manager", "R_roles_table");
	  Thread.sleep(2000);
	  }
  @Test(priority = 6)
  ...
  @Test(priority = 7)
  public void Check_New_User_is_Linked_to_OnGuard_Connext_Account_Manager_ChieldRole() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Verify that New User is linked to OnGuard Connext Account Manager Role");	  
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1),"Yes");
	  Thread.sleep(1000);
	  } 
  @Test(priority = 8)
  public void Delete_ChieldRole_with_Linked_User() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Delete Child role created for OnGuard Connext Account Manager Role");	 
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1),"No");
  ...
  @Test(priority = 9)
  public void Unlink_New_User_from_OnGuard_Connext_Account_Manager_ChieldRole() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Unlink New User to OnGuard Connext Account Manager Role");
	 // auth_obj.Users_Table(arr.get(0),"R_user_table");
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1),"No");
	  auth_obj.Users_Linked_to_Role_Table(arr.get(0), "R_roleslinked_Table");
  ...
  public void Delete_ChieldRole_After_Unlinking_New_User() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Delete Child role after unlinking from OnGuard Connext Account Manager Role ");	 
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1),"No");
	  auth_obj.Delete_New_AuthRol_button();
	  auth_obj.Notification();
	  auth_obj.Notification();
  ...
  @Test(priority = 11)
  public void Link_User_to_OnGuard_Connext_Credit_manager_Parent_Role() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Link New User to OnGuard Connext Account Manager Role");
	  auth_obj.Users_Table(arr.get(0),"R_user_table");
	  auth_obj.Chield_Role_Table("OnGuard Connext Credit Manager", "R_roles_table",arr.get(2),"No");
	  Thread.sleep(500);
	  auth_obj.Link_button();
	  auth_obj.Notification();
	  auth_obj.Notification();
	  ...
	  auth_obj.Notification();
	  auth_obj.Notification();
	  auth_obj.Expand_and_Collepse_Table("OnGuard Connext Credit Manager", "R_roles_table");
	  }
  @Test(priority = 12)
  public void Update_OnGuard_Connext_Credit_manager_Chield_Role() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  auth_obj.Chield_Role_Table("OnGuard Connext Credit Manager", "R_roles_table",arr.get(2),"No");
  ...
  @Test(priority = 13)
  public void Verify_Updated_OnGuard_Connext_Credit_manager_Chield_Role() throws IOException, InterruptedException {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  auth_obj.Chield_Role_Table("OnGuard Connext Credit Manager", "R_roles_table",arr.get(2)+" update","Yes");
	  }
  @Test(priority = 14)
  ...
  public void Verify_Saved_Chield_Role_using_Save_Icon() throws IOException, InterruptedException {
	  ...
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1)+" Save","Yes");	
	  Reporter.log("----------------------------------------");
  ...
  public void Verify_Saved_Chield_Role_using_Save_As_New_Icon() throws IOException, InterruptedException {
	  ...
	  Authorisations_Page auth_obj= PageFactory.initElements(driver, Authorisations_Page.class);
	  Reporter.log("Verify Saved Chield role under parent Role");	 
	  auth_obj.Chield_Role_Table("OnGuard Connext Account Manager", "R_roles_table",arr.get(1)+" SAN","No");	
	  Reporter.log("----------------------------------------");
	  Reporter.log("********Chield Role verified under Parent role using SAVE icon********");
	  Reporter.log("----------------------------------------");
	  }
