...
public class UserManager_Users extends TestListenerAdapter {	
	...
	public void Check_Save_as_New_button() throws Exception{
		...
		OG_CU1.Check_SendEmailBYme("UseSystemReplyAddress", "Yes", "Sumer", "password");
		Thread.sleep(1000);
		OG_CU1.Save_as_New();
		Thread.sleep(1000);
		OG_CU1.Notification();
	...
	public void Check_Save_and_Close_button() throws Exception{
		...
		U_edit.Select_Usergroup_to_Link("New User"+" "+arr.get(1),"Users_table","sort_users_table");
		Thread.sleep(1000);
		U_edit.Click_On_Change_icon();
		Thread.sleep(2000);
		OG_CU1.Enter_Name("New User1");
		OG_CU1.Enter_Initials(arr.get(1));
		OG_CU1.Select_Gender(arr.get(2));
		OG_CU1.Enter_Email("NewUser@yopmail.com");
		OG_CU1.Enter_LoginName("New User");
	...
	public void Check_Reload_button() throws Exception{
		...
		U_edit.Click_On_Change_icon();
		Thread.sleep(1000);
		OG_CU1.Enter_Name("New User Test");
		OG_CU1.Enter_Initials(arr.get(1));
		OG_CU1.Select_Gender(arr.get(2));
		OG_CU1.Enter_Email("NewUserTest@yopmail.com");
		OG_CU1.Enter_LoginName("New User Test");
		OG_CU1.Enter_LoginPassword(arr.get(5));
		OG_CU1.Enter_Confirm_Password(arr.get(6));
		OG_CU1.Reload();
		Thread.sleep(1000);
	...
	public void Link_Inactive_User_to_Usergroup() throws Exception{
		...
		eve.Table_event("New User1"+" "+arr.get(1),"Users_table");  //Select inactive users from table
	...
	public void UnLink_Inactive_User_from_UserGroup() throws Exception{
		...
		events eve= new events(driver);
		Users_Page link_user= PageFactory.initElements(driver, Users_Page.class);	
		eve.Table_event("New User1"+" "+arr.get(1),"LinkedWith_User_group_table");
		Thread.sleep(1000);
	...
	public void Delete_Inactive_User() throws Exception{
		...
		events eve= new events(driver);
		Users_Page link_user= PageFactory.initElements(driver, Users_Page.class);	
		eve.Table_event("New User1"+" "+arr.get(1),"Users_table");
		Thread.sleep(1000);
	...
	public void Link_Users_to_UserGroup() throws Exception{
		...
		Thread.sleep(2000);
		link_user.Select_Usergroup_to_Link(arr.get(0)+" "+arr.get(1),"Users_table","sort_users_table");// Select Second table i.e existing user selection 
		Thread.sleep(1000);
		link_user.link_User_icon();
		Thread.sleep(1000);
	...
	public void UnLink_From_UserGroup() throws Exception{
		...
		link_user.Select_Usergroup_to_Link(arr.get(0)+" "+arr.get(1),"LinkedWith_User_group_table","LinkedWith_User_group_table");
		Thread.sleep(1000);
		link_user.Unlink_User_icon();
		link_user.Save_All_icon();
		Thread.sleep(1000);
