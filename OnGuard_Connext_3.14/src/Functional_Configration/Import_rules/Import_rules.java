...
public class Import_rules {
  ...
  @Test(priority=4,description="APP-653:Create new customer rule by clicking on 'Create import rule' button")
  ...
  @Test(priority=5,description="APP-654:In customer rules tab ,Create action (Credit manager matching)")
  ...
  @Test(priority=6,description="APP-655:In customer rules tab ,Create action (Credit limit)")
  ...
  @Test(priority=9,description="APP-660:In design rule detail, check 'save and close' button when create customer rule")
  ...
  @Test(priority=10,description="APP-661:In design rule detail, check 'Reload' button when create customer rule")
  ...
  @Test(priority=16,description="APP-661:In design rule detail, check 'Reload' button when create customer rule")
  ...
  @Test(priority=22,description="APP-661:In design rule detail, check 'Reload' button when create customer rule")
  ...
  public void Create_Import_rule_for_Assign_Cost_scheme_in_Debtor_Rule() throws Exception {   //Added New
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Import_rules_Page ir_page= new Import_rules_Page(driver);
	  ir_page.Assign_Property_Action("30");          //Assign entity table option value in DDlist
	  ir_page.Create_import_rule_button();
	  Thread.sleep(1000);
  ...
  @Test(priority=28,description="APP-661:In design rule detail, check 'Reload' button when create customer rule")
 ...
 @Test(priority=29,description="APP-656:In customer rules tab ,Create action (customer monitoring)")
  ...
  @Test(priority=30,description="APP-663: In customer rules tab ,check 'Save and close' button")
  ...
  @Test(priority=31,description="APP-662: In customer rules tab ,check 'Save' and 'Cancel' button")
  ...
  @Test(priority=32,description="APP-664: In customer rules tab ,check 'Reload' button")
  ...
  @Test(priority=33,description="APP-666:In Invoice rule tab,Create invoice rules(Invoice monitoring)")
  ...
  @Test(priority=36,description="APP-667:In Invoice rule tab,Create invoice rules(Invoice monitoring)(date field)")
 ...
 @Test(priority=39,description="APP-668:In design rule detail, check 'save and close' button when create invoice rule")
  ...
  @Test(priority=54,description="APP-648:linking of rulebook to an administration")
  ...
  @Test(priority=55,description="Delete Linked Rulebook to Admin")
 ...
 @Test(priority=56,description="APP-650:unlink import rulebook from inactive administration")
  ...
  @Test(priority=57,description="APP-646:Delete Rulebook")
