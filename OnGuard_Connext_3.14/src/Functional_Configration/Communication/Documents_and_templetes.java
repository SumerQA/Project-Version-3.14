...
public class Documents_and_templetes {
  ...
  public void Enter_HTML_templete_orFile_Origin_name() throws IOException, InterruptedException {
	  ...
	  String filepath = templete_file.getAbsolutePath()+"/Letter_Email_templates/"+Fpath[0]; 
	  Thread.sleep(1000);
	  c_page.Templete("com_templete_orFile_Origin_name",file.getAbsolutePath()+"/upload.exe", "file:///"+filepath);
	  Thread.sleep(1000);
	  c_page.Notification();
	  Thread.sleep(1000);
  }
  ...
  public void Enter_RTF_templete_orFile_Origin_name() throws IOException, InterruptedException {
	  ...
	  String paths=  arr.get(9);
	  String[] Fpath = paths.split(",");
	  String filepath =  templete_file.getAbsolutePath()+"/Letter_Email_templates/"+Fpath[1]; 
  ...
  public void Enter_SMS_templete_orFile_Origin_name() throws IOException, InterruptedException {
	  ...
	  String paths=  arr.get(9);
	  String[] Fpath = paths.split(",");
	  String filepath =  templete_file.getAbsolutePath()+"/Letter_Email_templates/"+Fpath[2]; 
	  //String filepath =  arr.get(9);
	  Thread.sleep(1000);
	  c_page.Templete("com_templete_orFile_Origin_name",file.getAbsolutePath()+"/upload.exe", "file:///"+filepath);
	  Thread.sleep(1000);
  ...
  public void Verify_Invalid_templete_in_Dunning_letter_templetes_table() throws IOException, InterruptedException {
	  ...
	  String paths=  arr.get(9);
	  String[] Fpath = paths.split(",");
	  String filepath =  templete_file.getAbsolutePath()+"/Letter_Email_templates/"+Fpath[3]; 
  ...
  public void Update_HTML_templete_in_Dunning_letter_templetes_table() throws IOException, InterruptedException {
	  ...
	  String paths=  arr.get(9);
	  String[] Fpath = paths.split(",");
	  String filepath =  templete_file.getAbsolutePath()+"/Letter_Email_templates/"+Fpath[4]; 
	  File file1 = new File("Autoit_Script");
	  c_page.Templete("com_templete_orFile_Origin_name",file1.getAbsolutePath()+"/upload.exe", "file:///"+filepath);
	  Thread.sleep(1000);
	  c_page.Notification();
	  Thread.sleep(1000);
	  c_page.Save();
