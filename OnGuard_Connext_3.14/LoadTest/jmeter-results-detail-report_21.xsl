...
<xsl:param    name="titleReport" select="'OutBound API Report'"/>
...
<xsl:template name="pageHeader">
	...
	<table width="100%">
		<tr>
			<td align="right">Report Created by <a href="https://www.linkedin.com/in/sumer-singh-19a68937/">Sumer Singh</a> , <a href="http://seleniumhq.org">Sr.QA Automation Engineer</a>.</td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
				      ...
				      <img src="expand.png" alt="expand/collapse"><xsl:attribute name="id"><xsl:text/>page_details_<xsl:value-of select="position()" />_image</xsl:attribute></img>				      
                        ...
                        <tr class="page_details">
                           ...
                           <td colspan="8" bgcolor="#FF0000">
                              <div align="center">
			         <b>Details for API Call "<xsl:value-of select="$label" />"</b>
