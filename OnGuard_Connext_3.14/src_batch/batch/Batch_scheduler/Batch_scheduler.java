...
import batch_Pages.batch_Scheduler_page;
...
public class Batch_scheduler {
 ...
 @Test(priority=2)
  ...
  /*@Test(priority=46)
  public void open_Daily_Every_Day_Export_Scheduled_task() throws InterruptedException {
	  WebDriver driver= WebDriverManager.getDriverInstance();
	  batch_Scheduler_page ps_page = new batch_Scheduler_page(driver);
	  events eve = new events(driver);
	  ps_page.workweek_Task();
	  ...
	  ps_page.Show_full_Day();
	  Thread.sleep(1000);
	  ps_page.open_batch_log("BS_All_scheduled_task_grid", "Daily Every Day Export");
	  Thread.sleep(1000);
	  ps_page.Cancel();
	  Thread.sleep(3000);
