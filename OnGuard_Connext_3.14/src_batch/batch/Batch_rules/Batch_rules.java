...
import batch_Pages.Batch_rules_page;
import batch_Pages.queue_page;


@Listeners(ScreenShotOnFailure.class)
public class Batch_rules {
  @Test(priority=1)
  @Parameters({"Locale","Browser","URL"})
  public void Open_Batch_Section(String Locale,String Browser,String URL) throws Exception {
...
@Test(priority=2)
  ...
  public void Link_Batch_rule_to_MediaType_Email() throws InterruptedException, IOException {
	  ...
	  ES_page.UserName("tickytesting@gmail.com");
	  Thread.sleep(500);
	  ES_page.Password("beschuit");
	  ES_page.Check_Password("beschuit");
	  Thread.sleep(500);
	  ES_page.Email_Address("tickytesting@gmail.com");
	  Thread.sleep(500);
	  ES_page.Server_Name_SMTP("smtp.gmail.com");
	  Thread.sleep(500);
	  ES_page.port_SMTP("587");
	  Thread.sleep(500);
	  ES_page.Use_Encryption("SSL");
	  Thread.sleep(500);
